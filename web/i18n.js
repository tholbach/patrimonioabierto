...
const STRINGS = {
  es: {
    ...
    'filter.status_linked': 'Enlazado a Wikidata',
    ...
    'filter.all': 'Todo',
    'filter.none': 'Ninguno',
    'list.button_title': 'Ver como lista',
  ...
  en: {
    ...
    'filter.status_linked': 'Linked to Wikidata',
